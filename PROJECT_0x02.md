...
Description
First of three projects building the second iteration of a website cloning the basic features of the airbnb.com main page, circa 2014-2017.

Review of Object Relational Mapping from holbertonschool-higher_level_programming. Building a MySQL database as a second storage engine accessible from our back end Python console.
...
File(s): console.py models/ tests/
...
File(s): models/base_model.py models/city.py models/state.py models/engine/db_storage.py models/__init__.py
...
File(s): models/place.py models/user.py models/city.py
...
File(s): models/review.py models/user.py models/place.py
...
File(s): models/amenity.py models/place.py
